...
/-- Both creation opcodes commit the accounts and lifecycle fields of their bound creation call. -/
theorem creation_opcode_lifecycle {before after : Ethereum.State} {cost : Nat}
